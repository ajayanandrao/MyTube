...
import { buttonFalse, buttonTrue } from '../../Redux/CounterSlice';
        ...
        <div className='video-main-div'>
            ...
            <div className='d-block w-100'>
                <div className="video-grid">
                    ...
                    {mergedArray.slice(2).reverse().map((item, index) => {
                        return (
                            <div key={item.id}>
                                            ...
                                            <Link to="/" className='link'>
                                                ...
                                                >
                                                    {state ?
                                                        ...
                                                        />
                                                        :
                                                        <BiSolidVolumeFull style={{ fontSize: "20" }} onClick={() => pauseAllVideosTwo(index)}
                                                            onMouseOver={() => handleMouseOver(index)}
                                                        />
                                                    }
